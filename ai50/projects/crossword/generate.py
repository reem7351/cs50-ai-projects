...
class CrosswordCreator():
    ...
    def revise(self, x, y):
        ...
        for word_x in self.domains[x]:
            # If there is NO word_y that matches word_x at the overlap, remove word_x
    ...
    def consistent(self, assignment):
        ...
        """
            # All words must be correct length
    ...
    def select_unassigned_variable(self, assignment):
        ...
        # Sort by:
        # 1. Fewest domain values
        # 2. Highest degree (negative for descending)
        return min(
            unassigned,
            key=lambda var: (
    ...
    def backtrack(self, assignment):
        ...
        # Select an unassigned variable (MRV + degree heuristic)
        var = self.select_unassigned_variable(assignment)

        # Try values in order (least-constraining-value heuristic)
